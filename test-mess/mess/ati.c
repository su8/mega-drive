/* /1* #include "ati_meminfo.h" *1/ */
/* #include <stdio.h> */
/* #include <string.h> */
/* #include <stdlib.h> */
/* /1* #include <GL/glew.h> *1/ */
/* /1* #include <GL/wglew.h> *1/ */
/* #include <GL/glut.h> */
/* /1* #include <GL/gl.h> *1/ */
/* /1* #include <GL/glx.h> *1/ */
...
/* { */
/*   GLint param[4]; */
/*   /1* memset(param, 0, sizeof(param)); *1/ */

/*   glGetIntegerv (GL_TEXTURE_FREE_MEMORY_ATI, param); */
/*   printf ("VBO_FREE_MEMORY_ATI\n"); */
/*   printf ("  Total memory free in the pool: %d Kbyte\n", (int)param[0]/  1024); */
/*   /1* printf ("  Largest available free block in the pool: %i Kbyte\n", param[1]); *1/ */
/*   printf ("  Total auxiliary memory free: %d Kbyte\n", (int)param[2]/1024); */
/*   printf ("  Largest auxiliary free block: %i Kbyte\n", param[3]); */
/*   printf ("\n"); */

/*   /1* glGetIntegerv (TEXTURE_FREE_MEMORY_ATI, param); *1/ */
/*   /1* printf ("TEXTURE_FREE_MEMORY_ATI\n"); *1/ */
/*   /1* printf ("  Total memory free in the pool: %i Kbyte\n", param[0]); *1/ */
/*   /1* printf ("  Largest available free block in the pool: %i Kbyte\n", param[1]); *1/ */
/*   /1* printf ("  Total auxiliary memory free: %i Kbyte\n", param[2]); *1/ */
/*   /1* printf ("  Largest auxiliary free block: %i Kbyte\n", param[3]); *1/ */
/*   /1* printf ("\n"); *1/ */

/*   /1* glGetIntegerv (RENDERBUFFER_FREE_MEMORY_ATI, param); *1/ */
/*   /1* printf ("RENDERBUFFER_FREE_MEMORY_ATI\n"); *1/ */
/*   /1* printf ("  Total memory free in the pool: %i Kbyte\n", param[0]); *1/ */
/*   /1* printf ("  Largest available free block in the pool: %i Kbyte\n", param[1]); *1/ */
/*   /1* printf ("  Total auxiliary memory free: %i Kbyte\n", param[2]); *1/ */
/*   /1* printf ("  Largest auxiliary free block: %i Kbyte\n", param[3]); *1/ */
...
/* /1* GLuint gpuIDs[16] = {0}; *1/ */
/* /1* GLuint totalMemory[20], clockSpeed[20]; *1/ */
/* /1* /2* GLuint maxGpus = wglGetGPUIDsAMD(16, gpuIDs); *2/ *1/ */
/* /1* /2* wglGetGPUIDsAMD(0, 0); *2/ *1/ */ 
/* /1* GLint freeMem[4] = {0}; *1/ */
/* /1* glGetIntegerv(GL_TEXTURE_FREE_MEMORY_ATI, &freeMem[0]); *1/ */
/* /1* int availableMemory = freeMem[0] / 1024; *1/ */
/* /1* if(wglGetGPUInfoAMD(gpuIDs[0], WGL_GPU_RAM_AMD, GL_UNSIGNED_INT, sizeof(GLuint), &totalMemory) != 1) *1/ */
/* /1* int totalMemory = 0; *1/ */
/* /1* if(wglGetGPUInfoAMD(gpuIDs[0], WGL_GPU_CLOCK_AMD, GL_UNSIGNED_INT, sizeof(GLuint), &clockSpeed) != 1) *1/ */
/* /1* int clockSpeed = 0; *1/ */

/*   return 0; */
/* } */

/* /1* UINT n = wglGetGPUIDsAMD(0, 0); *1/ */
/* /1* UINT *ids = new UINT[n]; *1/ */
/* /1* size_t total_mem_mb = 0; *1/ */
/* /1* wglGetGPUIDsAMD(n, ids); *1/ */
/* /1* wglGetGPUInfoAMD(ids[0], *1/ */ 
/* /1*   WGL_GPU_RAM_AMD, *1/ */ 
/* /1*   GL_UNSIGNED_INT, *1/ */ 
/* /1*   sizeof(size_t), *1/ */
/* /1*   &total_mem_mb); *1/ */
